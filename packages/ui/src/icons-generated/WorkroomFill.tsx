...
const SvgWorkroomFill = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g fill='#7008E7' clipPath='url(#workroom-fill_svg__a)'>
    ...
    <defs>
      <clipPath id='workroom-fill_svg__a'>
        <path fill='currentColor' d='M2 2h20v20H2z' />
      </clipPath>
    </defs>
  </svg>
);
export default SvgWorkroomFill;
