...
export default function CancelAlert({
    ...
    return (
      ...
      >
        <div className='flex flex-col gap-y-5'>
          <h2 className='text-base-exl-18-2 text-red-500'>등록 취소하기</h2>
          <p className='text-base-l-16-1'>
            작업실 자랑하기 등록을 취소합니다. 해당 내용은 임시저장 되지
            않습니다.
          </p>
        </div>
      </ModalBottomSheet>
  ...
  return (
    <Alert
      ...
      variant='negative'
      title='등록 취소하기'
      content='작업실 자랑하기 등록을 취소합니다. 해당 내용은 임시저장 되지 않습니다.'
      cancelLabel='돌아가기'
      confirmLabel='등록 취소하기'
    />
  );
}
